...
class get_Container_Private_TwigService extends App_KernelDevDebugContainer
{
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'E:\\rest');
        $a->addPath('E:\\rest\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('E:\\rest\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('E:\\rest\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', 'DoctrineMigrations');
        $a->addPath('E:\\rest\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', '!DoctrineMigrations');
        $a->addPath('E:\\rest\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('E:\\rest\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('E:\\rest/templates');
        $a->addPath('E:\\rest\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(($container->privates['debug.file_link_formatter'] ?? ($container->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL))), 'E:\\rest', 'UTF-8'));
